...
export async function summarize(query, model, contextEntries) {
  const actualQuery = [
    ...
    contextEntries.join("\n\n"),
    "---------------------",
    "Given ONLY the transcript from video and not prior knowledge, answer the question. Do not provide personal opinion. Do not comment on the video transcript. Output answer in russian language. Question: " + query
  ].join("\n");
